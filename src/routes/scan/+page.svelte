...
<div class="space-y-4">
  ...
  <p>
    By default, running dotenv-diff will scan your entire codebase to detect
    every environment variable reference. It wil automatically compare against your .env file.
  </p>
